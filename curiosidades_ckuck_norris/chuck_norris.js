...
var titulo_curiosidade = curiosidades_chuck_norris[numero_sorteado].titulo;
var conteudo_curiosidade = curiosidades_chuck_norris[numero_sorteado].conteudo;

console.log("\nCURIOSIDADE SOBRE CHUCK NORRIS");
console.log(`Título: ${titulo_curiosidade}`);
console.log(`Curiosidade: ${conteudo_curiosidade}\n`);
